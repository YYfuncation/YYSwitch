...
- (UIButton *)switchButton{
    if (!_switchButton) {
        ...
        [_switchButton setImage:[UIImage imageNamed:@"chacha"] forState:UIControlStateNormal];
        [_switchButton setImage:[UIImage imageNamed:@"duihao"] forState:UIControlStateSelected];
